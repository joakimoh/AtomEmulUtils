...
enum DeviceId {
	TI4689_DEV, BEEB_SERIAL_ULA_DEV, ACIA6850_DEV, BEEB_PAGED_ROM_SEL_DEV, CRTC6845_DEV, TT_5050_DEV, BEEB_KEYBOARD_DEV, BEEB_VDU_DEV, TAPE_RECORDER_DEV, ATOM_SPEAKER_DEV, ATOM_CUTS_DEV, ROM_DEV, RAM_DEV, PIA8255_DEV, VDU6847_DEV, VIA6522_DEV, ATOM_KB_DEV, P6502_DEV, UNDEFINED_DEV
};
#define _DEVICE_ID(x) (\
