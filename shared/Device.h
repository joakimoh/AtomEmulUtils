...
enum DeviceId {
	DAC_ZN428_DEV, ADC_7002_DEV, SD_CARD, LATCH_74LS259, SN76489_DEV, BEEB_SERIAL_ULA_DEV,
	ACIA6850_DEV, BEEB_PAGED_ROM_SEL_DEV, CRTC6845_DEV, SAA5050_DEV,
...
#define _DEVICE_ID(x) (\
	x==ROM_DEV?"ROM":(x==RAM_DEV?"RAM":(x==PIA8255_DEV?"8255 PIA":(x==VDU6847_DEV?"6847 VDU":(x==VIA6522_DEV?"6522 VIA":\
(x==ATOM_KB_DEV?"ATOM KB":(x==P6502_DEV?"6502":(x==ATOM_CUTS_DEV?"CUTS":(x==TAPE_RECORDER_DEV?"Tape Recorder":\
(x==ATOM_SPEAKER_DEV?"Atom Speaker":(x==BEEB_VDU_DEV?"Beeb VDU":(x==BEEB_KEYBOARD_DEV?"Beeb Keyboard":(x==CRTC6845_DEV?"6845 CRTC":\
(x==SAA5050_DEV?"SA5050 TCG":(x==BEEB_PAGED_ROM_SEL_DEV?"Beeb Paged Rom Register":(x==ACIA6850_DEV?"6850 ACIA":\
(x==BEEB_SERIAL_ULA_DEV?"Beeb Serial ULA":(x==SN76489_DEV?"SN76489 Sound Chip":\
(x==LATCH_74LS259?"Beeb IC31/IC32 Latch":(x==SD_CARD?"SD Card":(x==ADC_7002_DEV?"7002 ADC":(x==PROXY_MEM_MAPPED_DEV?"Proxy Memory-mapped Device":(x==DAC_ZN428_DEV?"ZN428 DAC":"???")))))\
))))\
))))))))))))))
