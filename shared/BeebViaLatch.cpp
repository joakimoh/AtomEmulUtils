...
BeebViaLatch::BeebViaLatch(string name, double tickRate, DebugTracing* debugTracing, ConnectionManager* connectionManager):
	Device(name, BEEB_VIA_LATCH, PERIPHERAL, debugTracing, connectionManager)
{
