...
public:
	...
	vector<InstructionInfo> instructions {
		...
		{0x75, ADC, 					ZeroPage_X,		4, false, true},
		{0x6d, ADC, 					Absolute,		4, false, true},
		{0x7d, ADC, 					Absolute_X,		4, true , true},
		{0x79, ADC, 					Absolute_Y,		4, true , true},
		{0x61, ADC, 					Indirect_X,		6, false, true},
		{0x71, ADC, 					Indirect_Y,		5, true , true},
		{0x29, AND, 					Immediate,		2, false , false},
		{0x25, AND, 					ZeroPage,		3, false , true},
		{0x35, AND, 					ZeroPage_X,		4, false , true},
		{0x2d, AND, 					Absolute,		4, false , true},
		{0x3d, AND, 					Absolute_X,		4, true , true},
		{0x39, AND, 					Absolute_Y,		4, true , true},
		{0x21, AND, 					Indirect_X,		6, false, true},
		{0x31, AND, 					Indirect_Y,		6, true , true},
		{0x0a, ASL, 					Accumulator,	2, false, false},
		{0x06, ASL, 					ZeroPage,		5, false, true},
		{0x16, ASL, 					ZeroPage_X,		6, false, true},
		{0x0e, ASL, 					Absolute,		6, false, true},
		{0x1e, ASL, 					Absolute_X,		7, false, true},
		{0x90, BCC, 					Relative,		2, true , false},
		{0xb0, BCS, 					Relative,		2, true , false},
		{0xf0, BEQ, 					Relative,		2, true , false},
		{0x24, BIT, 					ZeroPage,		3, false, true},
		{0x2c, BIT, 					Absolute,		4, false, false},
		{0x30, BMI, 					Relative,		2, true , false},
		{0xd0, BNE, 					Relative,		2, true , false},
		{0x10, BPL, 					Relative,		2, true , false},
		{0x00, BRK,						Implied,		7, false, false},
		{0x50, BVC, 					Relative,		2, true , false},
		{0x70, BVS, 					Relative,		2, true , false},
		...
		{0xd5, CMP, 					ZeroPage_X,		4, false, true},
		{0xcd, CMP, 					Absolute,		4, false, true},
		{0xdd, CMP, 					Absolute_X,		4, true , true},
		{0xd9, CMP, 					Absolute_Y,		4, true , true},
		{0xc1, CMP, 					Indirect_X,		6, false, true},
		{0xd1, CMP, 					Indirect_Y,		5, true , true},
		...
		{0xd6, DEC, 					ZeroPage_X,		6, false, true},
		{0xce, DEC, 					Absolute,		6, false, true},
		{0xde, DEC, 					Absolute_X,		7, false, true},
		...
		{0x36, ROL, 					ZeroPage_X,		6, false, true },
		{0x2e, ROL, 					Absolute,		6, false, true },
		{0x3e, ROL, 					Absolute_X,		7, false, true },
		{0x6a, ROR, 					Accumulator,	2, false, false},
		{0x66, ROR, 					ZeroPage,		5, false, true },
		{0x76, ROR, 					ZeroPage_X,		6, false, true },
		{0x6e, ROR, 					Absolute,		6, false, true },
		{0x7e, ROR, 					Absolute_X,		7, false, true },
		...
		{0xf5, SBC, 					ZeroPage_X,		4, false, true },
		{0xed, SBC, 					Absolute,		4, false, true },
		{0xfd, SBC, 					Absolute_X,		4, true , true },
		{0xf9, SBC, 					Absolute_Y,		4, true , true },
		{0xe1, SBC, 					Indirect_X,		6, false, true },
		{0xf1, SBC, 					Indirect_Y,		5, true , true },
		...
		{0x95, STA, 					ZeroPage_X,		4, false, false},
		{0x8d, STA, 					Absolute,		4, false, false},
		{0x9d, STA, 					Absolute_X,		5, false, false},
		{0x99, STA, 					Absolute_Y,		5, false, false},
		{0x81, STA, 					Indirect_X,		6, false, false},
		{0x91, STA, 					Indirect_Y,		6, false, false},
		...
		{0x94, STY, 					ZeroPage_X,		4, false, false},
