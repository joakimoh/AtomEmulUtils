...
public:
	...
	vector<InstructionInfo> instructions {
		...
		{0x61, ADC, 					PreInd_X,		6, false,	true},
		{0x71, ADC, 					PostInd_Y,		5, true,	true},
		...
		{0x21, AND, 					PreInd_X,		6, false,	true},
		{0x31, AND, 					PostInd_Y,		5, true,	true},
		...
		{0xc1, CMP, 					PreInd_X,		6, false,	true},
		{0xd1, CMP, 					PostInd_Y,		5, true,	true},
		...
		{0x41, EOR, 					PreInd_X,		6, false,	true},
		{0x51, EOR, 					PostInd_Y,		5, true ,	true},
		...
		{0xa1, LDA, 					PreInd_X,		6, false,	true},
		{0xb1, LDA, 					PostInd_Y,		5, true ,	true},

		{0xa2, LDX, 					Immediate,		2, false,	false},
		{0xa6, LDX, 					ZeroPage,		3, false,	true},
		{0xb6, LDX, 					ZeroPage_Y,		4, false,	true },
		{0xae, LDX, 					Absolute,		4, false,	true},
		{0xbe, LDX, 					Absolute_Y,		4, true,	true},
		...
		{0x01, ORA, 					PreInd_X,		6, false,	true },
		{0x11, ORA, 					PostInd_Y,		5, true,	true },
		...
		{0xe1, SBC, 					PreInd_X,		6, false,	true},
		{0xf1, SBC, 					PostInd_Y,		5, true,	true},
		...
		{0x81, STA, 					PreInd_X,		6, false,	false},
		{0x91, STA, 					PostInd_Y,		6, false,	false},
