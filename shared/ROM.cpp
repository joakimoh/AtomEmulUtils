...
ROM::ROM(string name, double clockSpeed, uint16_t adr, uint16_t sz, string binaryContent, DebugManager  *debugManager, ConnectionManager* connectionManager) :
	MemoryMappedDevice(name, ROM_DEV, MEMORY_DEVICE, clockSpeed, adr, sz, debugManager, connectionManager)
{
