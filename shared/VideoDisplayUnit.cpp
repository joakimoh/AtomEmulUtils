...
VideoDisplayUnit::VideoDisplayUnit(
	string name, DeviceId devId, Display *display, uint8_t accessSpeed, 
	...
	MemoryMappedDevice(name, devId, VDU_DEVICE, accessSpeed, adr, sz, debugTracing, connectionManager, deviceManager),
