...
public:
	...
	VDU6847(string name, uint16_t adr, double clockSpeed, ALLEGRO_DISPLAY* disp, ALLEGRO_BITMAP* dispBitmap, int dispW, int dispH, uint16_t videoMemAdr, DebugManager  *debugManager, ConnectionManager* connectionManager);
	~VDU6847();
